...
|  🟢 普通 正常地以关键词触发内容。 🔵 常数 不需要输入关键词，每次对话都会触发该条目内容，插入上下文。 ❌ 禁用 该条目无法被触发。  |  小贴士： 还记得我在上面说过，世界书设置为常数以后，就变成永久 prompt 了吗？此时，若搭配插入深度使用，就可以使世界书发挥和作者注释相同的作用了！  |
| :---- | :---- |
